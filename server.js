...
async function GenerateFlipTable(League, LeagueExaltedValue) {
  ...
  TableArray = await TableArray.sort((a, b) => {
...
async function GenerateCurrencyCardsTableRowJson(League, LeagueExaltedValue, Details) {
  ...
  const CardExaltedPrice = Object.prototype.hasOwnProperty.call(CardData, 'exaltedValue') ? CardData.exaltedValue : helper.ChaosToExalted(LeagueExaltedValue, CardData.chaosValue);
...
async function GenerateCardsTableRowJson(League, LeagueExaltedValue, Details) {
  ...
  const CardExaltedPrice = Object.prototype.hasOwnProperty.call(CardData, 'exaltedValue') ? CardData.exaltedValue : helper.ChaosToExalted(LeagueExaltedValue, CardData.chaosValue);
  const RewardExaltedValue = Object.prototype.hasOwnProperty.call(RewardData, 'exaltedValue') ? RewardData.exaltedValue : helper.ChaosToExalted(LeagueExaltedValue, RewardData.chaosValue);
...
async function SendSocketData(League, sock = IO) {
  if (!Object.prototype.hasOwnProperty.call(TableData, League)) {
    const result = {
      success: false,
      details: {},
    };
